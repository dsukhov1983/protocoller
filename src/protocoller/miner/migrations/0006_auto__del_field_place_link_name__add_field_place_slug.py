...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Place.link_name'
        db.delete_column('miner_place', 'link_name')

        # Adding field 'Place.slug'
        db.add_column('miner_place', 'slug', self.gf('django.db.models.fields.CharField')(default='', max_length=20, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Place.link_name'
        db.add_column('miner_place', 'link_name', self.gf('django.db.models.fields.CharField')(default='', max_length=20, db_index=True), keep_default=False)

        # Deleting field 'Place.slug'
        db.delete_column('miner_place', 'slug')
    ...
    models = {
        ...
        'miner.competition': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 25, 22, 29, 53, 220753)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'miner.place': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'slug': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20', 'db_index': 'True'})
        },
        'miner.rawresult': {
        ...
        'miner.sportevent': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 25, 22, 29, 53, 219752)', 'auto_now': 'True', 'blank': 'True'}),
