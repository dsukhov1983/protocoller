...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SportEvent.standing'
        db.delete_column('miner_sportevent', 'standing')

        # Adding field 'SportEvent._description_rendered'
        db.add_column('miner_sportevent', '_description_rendered', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Changing field 'SportEvent.description'
        db.alter_column('miner_sportevent', 'description', self.gf('markitup.fields.MarkupField')(null=True, no_rendered_field=True))


    def backwards(self, orm):
        
        # Adding field 'SportEvent.standing'
        db.add_column('miner_sportevent', 'standing', self.gf('django.db.models.fields.TextField')(default='', null=True), keep_default=False)

        # Deleting field 'SportEvent._description_rendered'
        db.delete_column('miner_sportevent', '_description_rendered')

        # Changing field 'SportEvent.description'
        db.alter_column('miner_sportevent', 'description', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'miner.competition': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 30, 23, 53, 29, 103163)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'miner.sportevent': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 30, 23, 53, 29, 101906)', 'auto_now': 'True', 'blank': 'True'}),
