...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place._description_rendered'
        db.add_column('miner_place', '_description_rendered', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Changing field 'Place.description'
        db.alter_column('miner_place', 'description', self.gf('markitup.fields.MarkupField')(null=True, no_rendered_field=True))


    def backwards(self, orm):
        
        # Deleting field 'Place._description_rendered'
        db.delete_column('miner_place', '_description_rendered')

        # Changing field 'Place.description'
        db.alter_column('miner_place', 'description', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'miner.competition': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 26, 0, 34, 3, 303121)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'miner.place': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'description': ('markitup.fields.MarkupField', [], {'default': "''", 'null': 'True', 'no_rendered_field': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        'miner.sportevent': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 26, 0, 34, 3, 302007)', 'auto_now': 'True', 'blank': 'True'}),
