...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RegistrationInfo.city'
        db.alter_column('miner_registrationinfo', 'city', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'RegistrationInfo.club'
        db.alter_column('miner_registrationinfo', 'club', self.gf('django.db.models.fields.CharField')(max_length=30))


    def backwards(self, orm):
        
        # Changing field 'RegistrationInfo.city'
        db.alter_column('miner_registrationinfo', 'city', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'RegistrationInfo.club'
        db.alter_column('miner_registrationinfo', 'club', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    ...
    models = {
        ...
        'miner.competition': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 2, 0, 46, 59, 93712)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'miner.registrationinfo': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30', 'db_index': 'True', 'blank': 'True'}),
        ...
        'miner.sportevent': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 2, 0, 46, 59, 92689)', 'auto_now': 'True', 'blank': 'True'}),
