...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Competition.start_time'
        db.add_column('miner_competition', 'start_time', self.gf('django.db.models.fields.TimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Competition.start_time'
        db.delete_column('miner_competition', 'start_time')
    ...
    models = {
        ...
        'miner.competition': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 23, 22, 57, 38, 986988)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'miner.sportevent': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 23, 22, 57, 38, 985586)', 'auto_now': 'True', 'blank': 'True'}),
