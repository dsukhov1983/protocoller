...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing index on 'RegistrationInfo', fields ['city']
        #db.delete_index('miner_registrationinfo', ['city'])

        # Adding field 'SportEvent.protocol_file'
        db.add_column('miner_sportevent', 'protocol_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding index on 'RegistrationInfo', fields ['city']
        #db.create_index('miner_registrationinfo', ['city'])

        # Deleting field 'SportEvent.protocol_file'
        db.delete_column('miner_sportevent', 'protocol_file')
    ...
    models = {
        ...
        'miner.competition': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 15, 22, 18, 16, 68296)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'miner.sportevent': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 15, 22, 18, 16, 66965)', 'auto_now': 'True', 'blank': 'True'}),
