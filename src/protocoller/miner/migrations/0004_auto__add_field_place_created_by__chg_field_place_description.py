...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('miner_place', 'created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('miner_place', 'created_by_id')

        # Changing field 'Place.description'
        db.alter_column('miner_place', 'description', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'miner.competition': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 24, 0, 16, 37, 386734)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'miner.sportevent': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 24, 0, 16, 37, 385310)', 'auto_now': 'True', 'blank': 'True'}),
