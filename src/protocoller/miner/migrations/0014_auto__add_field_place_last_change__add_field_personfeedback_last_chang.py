...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.last_change'
        db.add_column('miner_place', 'last_change', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 2, 10, 20, 54, 52, 199435), auto_now=True, blank=True), keep_default=False)

        # Adding field 'PersonFeedback.last_change'
        db.add_column('miner_personfeedback', 'last_change', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 2, 10, 20, 54, 52, 206054), auto_now=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.last_change'
        db.delete_column('miner_place', 'last_change')

        # Deleting field 'PersonFeedback.last_change'
        db.delete_column('miner_personfeedback', 'last_change')
    ...
    models = {
        ...
        'miner.competition': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 10, 20, 54, 52, 201477)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'miner.personfeedback': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 10, 20, 54, 52, 206054)', 'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20', 'null': 'True', 'db_index': 'True'}),
        ...
        'miner.place': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'description': ('markitup.fields.MarkupField', [], {'default': "''", 'null': 'True', 'blank': 'True', 'no_rendered_field': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 10, 20, 54, 52, 199435)', 'auto_now': 'True', 'blank': 'True'}),
            'link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'slug': ('django.db.models.fields.CharField', [], {'default': "''", 'unique': 'True', 'max_length': '20', 'db_index': 'True'})
        },
        'miner.rawresult': {
        ...
        'miner.registrationinfo': {
            ...
            'club': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'surname': ('django.db.models.fields.CharField', [], {'max_length': '30', 'db_index': 'True'}),
            'year': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'db_index': 'True'})
        },
        ...
        'miner.sportevent': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 10, 20, 54, 52, 200336)', 'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'place': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['miner.Place']", 'null': 'True'}),
            'protocol_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
